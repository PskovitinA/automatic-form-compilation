...
function attorneySelect($attArg){
    $attorneyArray = array(
        'NUR' => array('Начальника управления по сервису Темирбаевой Нургуль Сериковны, действующей на основании Доверенности № 27 от 12.02.2019 г.','Начальник управления по сервису','Темирбаева Нургуль Сериковна','Темирбаева Н.С.'),
    ...
    switch ($attArg) {
        ...
        case 'OKE':
            ...
            break;
        case 'NUR':
            $attorney = $attorneyArray['NUR'][0];
            $attorneyPosition = $attorneyArray['NUR']['1'];
            $attorneyShortName = $attorneyArray['NUR'][3];
            break;
    }
